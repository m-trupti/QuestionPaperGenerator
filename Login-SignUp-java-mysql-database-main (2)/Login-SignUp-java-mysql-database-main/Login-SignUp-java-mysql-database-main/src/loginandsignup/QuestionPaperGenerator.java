 ...
 * @author aparn
 */
public class QuestionPaperGenerator extends javax.swing.JFrame {
    ...
    /**
     * Creates new form QuestionPaperGenerator
     */
    public QuestionPaperGenerator() {
        
        super("Question Paper Generator");
        ...
        generateButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                generateQuestionPaper(marks, numOfQuestions, sub);
            }
        });
    ...
    private void generateQuestionPaper(int marks, int numOfQuestions, String sub) {
        /*SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss");
        String timestamp = dateFormat.format(new Date());
        String filename = (timestamp+"QuestionPaper.pdf");
        ...
        */
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            String query = "SELECT * FROM questions WHERE subject = '"+sub+"' AND marks IN (5, 6) ORDER BY RAND()";
            ...
            while (resultSet.next()) {
                ...
                if (questionMarks == marks && count<=numOfQuestions) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuestionPaperGenerator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuestionPaperGenerator().setVisible(true);
            }
        });
    }
/*
